...
class HomeScreenViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print ("Now on HomeScreen: \(username), \(userID)")
        
        //rootRef.child(username!).child("Noticias").child("noticia").setValue(
        //    ["name":"film 1"]
        //)
...
extension HomeScreenViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        //if let viewDetail = NewsDetailViewController.getViewController() {
            ...
            viewDetail.username = username
            viewDetail.userID = userID
